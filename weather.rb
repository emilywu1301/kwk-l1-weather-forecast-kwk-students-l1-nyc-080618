...
def current_weather(weather)
  puts "The weather in #{city(weather)} is #{description(weather)}. The temperature is #{temperature_farenheit(weather)} degrees Farenheit."
end
